...
void help() {
    ...
    std::cout << "Usage: rtneural_compare_bench <layer_type> <length> <size>" << std::endl;
    std::cout << "    Note that for activation layers the out_size argument is ignored."
              << std::endl;
}
...
int main(int argc, char *argv[]) {
    ...
    std::cout << "Benchmarking " << layer_type << " layer, with input size " << size
              << " and output size " << size << ", with signal length " << length_seconds
              << " seconds" << std::endl;
    ...
    std::cout << "Processed " << length_seconds << " seconds of signal in " << duration
              << " seconds" << std::endl;
